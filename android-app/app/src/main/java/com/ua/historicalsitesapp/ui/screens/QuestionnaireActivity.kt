...
fun QuestionnaireMenu() {
  ...
  // This could be two buttons yes or no instead of chips. Do make it mandatory to do the
  // questionnaire?
  val questions =
      listOf(
          "Favorite Historical Figure:" to
              listOf(
                  "Alexander the Great",
                  "Cleopatra",
                  "Leonardo da Vinci",
          ...
          "How do you feel about visiting historical sites with interactive exhibits?" to
              listOf(
                  "Very Interested",
                  "Somewhat Interested",
                  "Neutral",
  ...
  QuestionnaireCard(
      ...
      onAnswer = { options -> selectedOptions = options },
      onNext = {
