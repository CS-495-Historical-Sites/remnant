...
def unsuccesful_login_attempts(email: str, success: bool):
    return LoginAttempt.query.filter(LoginAttempt.attempt_time > (datetime.utcnow() - timedelta(minutes=-1))).count()
